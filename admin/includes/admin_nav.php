...
<button class="close-module-btn" onclick="document.getElementById('mobile-module-nav').classList.remove('mobile-open')"><i class="fa-solid fa-xmark"></i></button>
    ...
    <nav>
        <!-- PRIMARY DASHBOARD -->
        <a href="/share_hope/admin/dashboard.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'dashboard.php' ? 'active' : '' ?>">
        ...
        <a href="/share_hope/admin/campaigns_hub.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'campaigns_hub.php' ? 'active' : '' ?>">
            <i class="fa-solid fa-bullhorn" style="width: 20px;"></i>
            <span>Fundraising Campaigns</span>
        </a>

        <!-- COMMUNICATIONS (UNIFIED) -->
        <a href="/share_hope/admin/communications.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'communications.php' ? 'active' : '' ?>">
        ...
        <a href="/share_hope/admin/stakeholders.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'stakeholders.php' ? 'active' : '' ?>">
        ...
        <div id="finance-menu" style="display: flex; flex-direction: column; gap: 0; background: rgba(0,0,0,0.2); border-radius: 0 0 var(--radius-md) var(--radius-md); margin: 0 0.75rem 0.5rem 0.75rem; overflow: hidden;">
            <a href="/share_hope/admin/all_donations.php" class="admin-sidebar-link" style="border-radius: 0; padding: 0.6rem 1rem; font-size: 0.9rem; border-left: 2px solid var(--accent); <?= basename($_SERVER['PHP_SELF']) === 'all_donations.php' ? 'background: rgba(0,217,255,0.1);' : '' ?>">
                <i class="fa-solid fa-hand-holding-heart" style="width: 16px; font-size: 0.9rem;"></i>
                <span>Donations Ledger</span>
            </a>
            
            <a href="/share_hope/admin/transaction_controls.php" class="admin-sidebar-link" style="border-radius: 0; padding: 0.6rem 1rem; font-size: 0.9rem; border-left: 2px solid var(--accent); <?= basename($_SERVER['PHP_SELF']) === 'transaction_controls.php' ? 'background: rgba(0,217,255,0.1);' : '' ?>">
                <i class="fa-solid fa-credit-card" style="width: 16px; font-size: 0.9rem;"></i>
                <span>Transactions</span>
            </a>
            
            <a href="/share_hope/admin/finance_controls.php" class="admin-sidebar-link" style="border-radius: 0; padding: 0.6rem 1rem; font-size: 0.9rem; border-left: 2px solid var(--accent); <?= basename($_SERVER['PHP_SELF']) === 'finance_controls.php' ? 'background: rgba(0,217,255,0.1);' : '' ?>">
        ...
        <a href="/share_hope/admin/analytics.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'analytics.php' ? 'active' : '' ?>">
            <i class="fa-solid fa-chart-pie" style="width: 20px;"></i>
            <span>Analytics Dashboard</span>
        </a>
        
        <a href="/share_hope/admin/campaign_updates_review.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'campaign_updates_review.php' ? 'active' : '' ?>" style="position:relative;">
        ...
        <a href="/share_hope/admin/activity_logs.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'activity_logs.php' ? 'active' : '' ?>">
