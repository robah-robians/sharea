...
<button class="close-module-btn" onclick="document.getElementById('mobile-module-nav').classList.remove('mobile-open')"><i class="fa-solid fa-xmark"></i></button>
    ...
    <nav>
        ...
        <a href="/share_hope/donor/dashboard.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'dashboard.php' ? 'active' : '' ?>">
            <i class="fa-solid fa-chart-pie" style="width: 20px;"></i>
            <span>Dashboard</span>
        </a>
        <a href="/share_hope/campaigns.php" class="admin-sidebar-link">
        ...
        <a href="/share_hope/donor/donations.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'donations.php' ? 'active' : '' ?>">
            <i class="fa-solid fa-hand-holding-dollar" style="width: 20px;"></i>
            <span>My Donations</span>
        </a>
        <a href="/share_hope/donor/pledges.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'pledges.php' ? 'active' : '' ?>">
        ...
        <a href="/share_hope/donor/impact.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'impact.php' ? 'active' : '' ?>">
        ...
        <a href="/share_hope/donor/profile.php" class="admin-sidebar-link <?= basename($_SERVER['PHP_SELF']) === 'profile.php' ? 'active' : '' ?>">
